...
router.get('/', usersController.getUser); // mypage 회원정보 조회
router.patch('/', uploads.single('img'), usersController.updateUser); // 회원정보수정
router.delete('/', usersController.deleteUser); // 회원탈퇴
